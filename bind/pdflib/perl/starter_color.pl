#!/usr/bin/perl
# $Id: starter_color.pl,v 1.1.2.3 2008/12/25 13:28:41 rp Exp $
# Starter color:
...
my $ searchpath = "../data";
my $ outfile = "starter_color.pdf";
my $ title = "Starter Color";
...
if ($@) {
    printf("starter_color: PDFlib Exception occurred:\n");
    printf(" $@\n");
    exit;
}

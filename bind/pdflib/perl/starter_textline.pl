#!/usr/bin/perl
# $Id: starter_textline.pl,v 1.1.2.3 2008/12/25 13:28:41 rp Exp $
# Starter text line:
...
my $searchpath = "../data";
my $outfile = "starter_textline.pdf";
my $title = "Starter Text Line";
...
my $y = 800;
my $yoff = 50;
my $textline = "Giant Wing Paper Plane";
...
if ($@) {
    printf("starter_textline: PDFlib Exception occurred:\n");
    printf(" $@\n");
    exit;
}

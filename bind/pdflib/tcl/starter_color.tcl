#!/bin/sh
# $Id: starter_color.tcl,v 1.1.2.4 2008/01/10 12:08:01 kurt Exp $
#
...
if { [catch {
	...
	PDF_fit_textline $p "1." [expr $x + $xoffset1] $y "" 
	...
	PDF_fit_textline $p "2." [expr $x + $xoffset1] $y \
	        "fillcolor={gray 0.5}" 
	...
	PDF_fit_textline $p "3." [expr $x + $xoffset1] $y \
	...
	PDF_fit_textline $p "Circle and text filled with {cmyk 0.1 0.7 0.7 0.1}" \
            [expr $x + $xoffset2] $y ""
	...
	PDF_fit_textline $p "4." [expr $x + $xoffset1] $y \
	...
	PDF_fit_textline $p "5." [expr $x + $xoffset1] $y \
	...
	set icchandle [PDF_load_iccprofile $p "sRGB" "usage=iccbased"]
	...
	PDF_fit_textline $p	"Circle and text filled with {iccbasedrgb 0.1 0.95 0.3}" \
            [expr $x + $xoffset2] $y ""
	...
	PDF_fit_textline $p "6." [expr $x + $xoffset1] $y \
	...
	set spot [PDF_makespotcolor $p "PANTONE 281 U"]
	...
	PDF_fit_textline $p	"Circle and text filled with {spotname {PANTONE 281 U} 1}" \
            [expr $x + $xoffset2] $y ""
	...
	PDF_fit_textline $p "7." [expr $x + $xoffset1] $y \
		"fillcolor={spotname {PANTONE 281 U} 1}" 

	# or 
	PDF_fit_textline $p "7." [expr $x + $xoffset1] $y "fillcolor={spot $spot 1}"
